//
//  DWAttributeStringViewController.m
//  FoundationDemo
//
//  Created by Dawn Wang on 2017/6/12.
//  Copyright © 2017年 Dawn Wang. All rights reserved.
//

#import "DWAttributeStringViewController.h"

@interface DWAttributeStringViewController ()

@end

@implementation DWAttributeStringViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    NSMutableAttributedString *string = [self attributeString];
    

    
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, 320, 0)];
    ...
    NSLog(@"%@",[string attributesAtIndex:0 effectiveRange:&range]);
}
